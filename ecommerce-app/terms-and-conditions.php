...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Terms and Conditions - Posh Auto Parts eCommerce Bootstrap 4 Html Template</title>
        <!-- Favicon  -->
    ...
    <body class="template-terms-conditions">
        <!-- Start Page Loader -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <h3 class="medium-title mt-0">Lorem ipsum dolor sit amet</h3>
                                ...
                                <h3 class="medium-title">Nulla pellentesque dignissim augue</h3>
                                ...
                                <p>Sit amet nisl purus in. Purus in mollis nunc sed id semper risus in. Laoreet id donec ultrices tincidunt arcu non sodales neque sodales. Ornare quam viverra orci sagittis eu volutpat odio. Semper viverra nam libero justo. Sem fringilla ut morbi tincidunt augue interdum velit euismod in. At lectus urna duis convallis convallis. Sed ullamcorper morbi tincidunt ornare massa eget egestas purus. Eu sem integer vitae justo. Senectus et netus et malesuada fames ac turpis. Nunc sed blandit libero volutpat sed. Nulla pellentesque dignissim enim sit amet. Est ultricies integer quis auctor. Et tortor consequat id porta.</p>
                            </div>
                        </div>
                    </div>
                </div>
