...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Forgot Password - Posh Auto Parts eCommerce Bootstrap 4 Html Template</title>
        <!-- Favicon  -->
    ...
    <body class="template-forgot-password account-page">
        <!-- Start Page Loader -->
                        ...
                        <div class="row row-sp">
                            <div class="col-sp col-12 col-sm-12 col-md-12 col-lg-6 offset-lg-3">
                                <div class="page-title text-center">
                                    <h1>Forgot Password</h1>
                                    <p class="subtitle mb-0">Email address you use to log in to your account. <br/> We'll send you an email with instructions to choose a new password. </p>
                                </div>

                                <form action="#" class="pass-forgot-form needs-validation" novalidate>
