                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                ...
                                                <a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-1.jpg" data-src="assets/images/products/product-1.jpg" alt="image" title="image" /></a>
                                                <div class="product-label clearfix">
                                                    <span class="label sale">Sale</span>
                                                </div>
                                                <h3 class="product-title mb-2"><a href="product-details.php">Donec pede justo fringilla</a></h3>
                                                <div class="product-price mt-1">
                                                    <span class="compare-price">$125.22</span>
                                                    <span class="sale-price">$113.88</span>
                                                </div>
                                                <form action="#">
                                                    <a href="cart.php" class="mt-3 btn btn-primary product-btn-cart add-cart">Add to Cart</a>
                                                </form>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                <a href="#" class="campare-remove close"><i class="ti-close"></i></a>
                                                <a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-1.jpg" data-src="assets/images/products/product-1.jpg" alt="image" title="image" /></a>
                                                <h3 class="product-title mb-2"><a href="product-details.php">Aenean commodo ligula eget dolor</a></h3>
                                                <div class="product-price mt-1">
                                        ...
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                <a href="#" class="campare-remove close"><i class="ti-close"></i></a>
                                                <a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-1.jpg" data-src="assets/images/products/product-1.jpg" alt="image" title="image" /></a>
                                                <h3 class="product-title mb-2"><a href="product-details.php">Sociosqu facilisi senectus</a></h3>
                                                <div class="product-price mt-1">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                ...
                                                <h3 class="product-title mb-2"><a href="product-details.php">Nullam scelerisque suscipit sociis</a></h3>
                                                <div class="product-price mt-1">
                                                    <span class="compare-price">$125.22</span>
                                                    <span class="sale-price">$113.88</span>
                                                </div>
                                        ...
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                <a href="#" class="campare-remove close"><i class="ti-close"></i></a>
                                                <a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-1.jpg" data-src="assets/images/products/product-1.jpg" alt="image" title="image" /></a>
                                                <h3 class="product-title mb-2"><a href="product-details.php">Consectetur adipisicing elit</a></h3>
                                                <div class="product-price mt-1">
                                                    <span class="sale-price">$70.15</span>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                <a href="#" class="campare-remove close"><i class="ti-close"></i></a>
                                                <a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-1.jpg" data-src="assets/images/products/product-1.jpg" alt="image" title="image" /></a>
                                                <h3 class="product-title mb-2"><a href="product-details.php">Pellentesque habitant morbi</a></h3>
                                                <div class="product-price mt-1">
                                                    <span class="sale-price">$133.50</span>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="pro-img-dec position-relative">
                                                <a href="#" class="campare-remove close"><i class="ti-close"></i></a>
                                                <a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-1.jpg" data-src="assets/images/products/product-1.jpg" alt="image" title="image" /></a>
                                                <h3 class="product-title mb-2"><a href="product-details.php">Neque porro quisquam dolorem</a></h3>
                                                <div class="product-price mt-1">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <form action="#">
                                                <a href="cart.php" class="btn btn-primary product-btn-cart add-cart">Add to Cart</a>
                                            </form>
                                        </td>
                                        <td class="text-center">
                                            <form action="#">
