...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Title -->
        <title>404 Page Not Found - Posh Auto Parts eCommerce Bootstrap 4 Html Template</title>
        <!-- Favicon  -->
    ...
    <body class="template-not-found-page">
        <!-- Start Page Loader -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-7 text-center">
                                <div class="page-not-found">
                                    ...
                                    <a href="index.php" class="back-btn btn btn-primary">Back to home page</a>
                                </div>
                            </div>
                        </div>
                    </div>
