                                ...
                                <div class="row row-sp row-eq-height">
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-list-1.jpg" data-src="assets/images/blog/blog-list-1.jpg" alt="image" title="Simple design, intense content Design is intelligence made visible" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">Simple design, intense content Design is intelligence made visible</a></h3>
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-12 col-md-12">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-list-1.jpg" data-src="assets/images/blog/blog-list-1.jpg" alt="image" title="Loremous Comodous - Trending" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-12 col-md-12">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-list-1.jpg" data-src="assets/images/blog/blog-list-1.jpg" alt="image" title="Lorem Quasi Maiores" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">Lorem Quasi Maiores</a></h3>
                                            <div class="article-by mb-4 clearfix">
                                                <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
