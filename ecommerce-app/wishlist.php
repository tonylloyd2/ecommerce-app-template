...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Wishlist - Posh Auto Parts eCommerce Bootstrap 4 Html Template</title>
        <!-- Favicon  -->
                    ...
                    <div class="container">
                        <div class="table-content table-responsive">
                            <table class="table table-bordered border-0 table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pro-img text-center"><a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-100x100.jpg" data-src="assets/images/products/product-100x100.jpg" alt="image" title="image" width="100" /></a></td>
                                        <td class="pro-del text-center text-sm-left">
                                            <p class="mb-1 pro-name"><a href="product-details.php">Donec pede justo fringilla</a></p>
                                        ...
                                        <td class="wishlist-cart-btn text-center"><a href="cart.php" class="btn btn-primary add-cart">Add to Cart</a></td>
                                        <td class="remove-wish text-center"><a class="wish-remove" href="#"><i class="ti-close"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td class="pro-img text-center"><a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-100x100.jpg" data-src="assets/images/products/product-100x100.jpg" alt="image" title="image" width="100" /></a></td>
                                        <td class="pro-del text-center text-sm-left">
                                            <p class="mb-1 pro-name"><a href="product-details.php">Aenean commodo ligula eget dolor</a></p>
                                            <p class="mb-1">Color: Black</p>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="pro-img text-center"><a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-100x100.jpg" data-src="assets/images/products/product-100x100.jpg" alt="image" title="image" width="100" /></a></td>
                                        <td class="pro-del text-center text-sm-left">
                                            <p class="mb-1 pro-name"><a href="product-details.php">Sociosqu facilisi senectus</a></p>
                                    ...
                                    <tr>
                                        <td class="pro-img text-center"><a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-100x100.jpg" data-src="assets/images/products/product-100x100.jpg" alt="image" title="image" width="100" /></a></td>
                                        <td class="pro-del text-center text-sm-left">
                                            <p class="mb-1 pro-name"><a href="product-details.php">Nullam scelerisque suscipit sociis</a></p>
                                            <p class="mb-1">Size: Large</p>
                                    ...
                                    <tr>
                                        <td class="pro-img text-center"><a href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-100x100.jpg" data-src="assets/images/products/product-100x100.jpg" alt="image" title="image" width="100" /></a></td>
                                        <td class="pro-del text-center text-sm-left">
                                            <p class="mb-1 pro-name"><a href="product-details.php">Consectetur adipisicing elit</a></p>
                                            <p class="mb-1">Size: Small</p>
                                        </td>
