                        ...
                        <div class="row row-sp row-eq-height">
                            ...
                            <div class="col-sp blog-item col-12 col-sm-6 col-md-4">
                                ...
                                <div class="blog-img mb-4">
                                    <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-1.jpg" data-src="assets/images/blog/blog-1.jpg" alt="image" title="image" /></a>
                                </div>
                                <!-- End Blog Image -->
                                <!-- Start Blog Details -->
                            ...
                            <div class="col-sp blog-item col-12 col-sm-6 col-md-4">
                                ...
                                <!-- Start Blog Details -->
                                <div class="blog-details">
                                    <h3><a href="single-post-image.php">risus an nulla mattis fermentum</a></h3>
                                    <div class="article-by mb-4 clearfix">
                                        <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
