                ...
                <div class="container-fluid full-header">
                    <div class="d-flex justify-content-between align-items-center">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="megamenu submenu dropdown">
                                            <ul>
                                                <li><a class="item" href="index.php">Home Version 1</a></li>
                                                <li><a class="item" href="index-v2.php">Home Version 2</a></li>
                                                <li><a class="item" href="index-v3.php">Home Version 3</a></li>
                                                <li><a class="item" href="boxed-layout.php">Boxed Version 4</a></li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-12 col-sm-12 col-lg-6">
                                                        <div class="row">
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-4">
                                                                ...
                                                                <ul>
                                                                    <li><a class="item" href="collections.php">Collections Version 1</a></li>
                                                                    <li><a class="item" href="collections-v2.php">Collections Version 2</a></li>
                                                                    <li><a class="item" href="shop-grid-fullwidth.php">Grid Full width</a></li>
                                                                    <li><a class="item" href="shop-grid-left-sidebar.php">Grid Left Sidebar</a></li>
                                                                    <li><a class="item" href="shop-grid-right-sidebar.php">Grid Right sidebar</a></li>
                                                                </ul>
                                                            </div>
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-4">
                                                                <h3>Categories Pages</h3>
                                                                <ul>
                                                                    ...
                                                                    <li><a class="item" href="shop-list-fullwidth.php">List Full width</a></li>
                                                                    <li><a class="item" href="shop-list-left-sidebar.php">List Left Sidebar</a></li>
                                                                    <li><a class="item" href="shop-list-right-sidebar.php">List Right sidebar</a></li>
                                                                    <li><a class="item" href="search-results.php">Search Results</a></li>
                                                                </ul>
                                                            </div>
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-4">
                                                                <h3>Product pages</h3>
                                                                <ul>
                                                                    <li><a class="item" href="product-details.php">Product Full width</a></li>
                                                                    <li><a class="item" href="product-details-classic.php">Product Classic</a></li>
                                                                    <li><a class="item" href="product-details-sidebar.php">Product Sidebar</a></li>
                                                                    <li><a class="item" href="product-details-group.php">Product Group</a></li>
                                                                    <li><a class="item" href="product-details-sticky.php">Product Sticky</a></li>
                                                            ...
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-4">
                                                                <h3>Shop pages</h3>
                                                                <ul>
                                                                    <li><a class="item" href="cart.php">Cart</a></li>
                                                                    <li><a class="item" href="checkout.php">Checkout</a></li>
                                                            ...
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-4">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><a class="item" href="single-post-image.php">Blog Details</a></li>
                                                                </ul>
                                                            </div>
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-4">
                                                                <h3>Other Pages</h3>
                                                    ...
                                                    <div class="megamenu-lvl product-col col-12 col-sm-12 col-lg-3">
                                                        ...
                                                        <div class="product">
                                                            <a class="pro-img" href="product-details.php"><img class="img-fluid blur-up lazyload" src="assets/images/megamenu/product-1.jpg" data-src="assets/images/megamenu/product-1.jpg" alt="image" title="Naminos elementum disus tincidunts cosmo de cosmopolis" /></a>
                                                            <div class="pro-details">
                                                                <h4><a href="product-details.php">Naminos elementum disus tincidunts cosmo de cosmopolis</a></h4>
                                                                <p class="star-rating">
                                                    ...
                                                    <div class="megamenu-lvl banner-col col-12 col-sm-12 col-lg-3">
                                                        <a href="collections.php"><img class="img-fluid blur-up lazyload" src="assets/images/megamenu/image-1.jpg" data-src="assets/images/megamenu/image-1.jpg" alt="image" title="image" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="megamenu-lvl banner-col col-12 col-sm-12 col-lg-3">
                                                        <div class="row">
                                                            <div class="col-sm-12 img1">
                                                                <a href="collections.php"><img class="img-fluid blur-up lazyload" src="assets/images/megamenu/image-2.jpg" data-src="assets/images/megamenu/image-2.jpg" alt="image" title="image" /></a>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-3">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><a class="item" href="wishlist.php">My Wishlist</a></li>
                                                                    <li><a class="item" href="cart.php">Shopping Cart</a></li>
                                                                </ul>
                                                            </div>
                                                            <div class="megamenu-lvl col-12 col-sm-12 col-lg-3">
                        ...
                        <div class="navbar-brand logo mx-auto p-0 text-center">
                            <a href="index.php" class="logo-img"><img class="img-fluid" src="assets/images/logo/logo.png" alt="logo" title="Posh Auto Parts" /></a>
                        </div>
                        <!-- End Logo -->
                        <!-- Start Right Menu -->
                        ...
                        <div class="row">
                            ...
                            <div class=" col-12 col-sm-12 col-lg-3 blog-sidebar sidebar sidebar-left">
                                ...
                                <div class="cms-block popular-tags">
                                    ...
                                    <div class="cms-block-content">
                                        <ul class="d-flex flex-row flex-wrap color-item">
                                            ...
                                            <li class="tag-btn"><a class="btn btn-secondary" href="blog.php">View All</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- End Popular Tags -->
                                ...
                                <div class="cms-block popular-tags d-none d-lg-block">
                                    <a class="d-block" href="shop-grid-fullwidth.php"><img class="img-fluid blur-up lazyload" src="assets/images/banner/fillter-banner.jpg" data-src="assets/images/banner/fillter-banner.jpg" alt="image" title="image" /></a>
                                </div>
                                <!-- End Custom Banner -->
                            </div>
                            <!-- End Product Filter -->
                                ...
                                <div class="row row-sp row-eq-height">
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-6 col-md-6">
                                        ...
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-2.jpg" data-src="assets/images/blog/blog-2.jpg" alt="image" title="Aliquam tincidunt mauris eu risus" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">Aliquam tincidunt mauris eu risus</a></h3>
                                            ...
                                            <a href="single-post-image.php" class="btn btn-secondary">Read More<i class="ml-2 fa fa-long-arrow-right"></i></a>
                                        </div>
                                        <!-- End Blog Details -->
                                    </div>
                                    <!-- End Blog Item -->
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-6 col-md-6">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-2.jpg" data-src="assets/images/blog/blog-2.jpg" alt="image" title="Aliquam tincidunt mauris" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">Aliquam tincidunt mauris</a></h3>
                                            <div class="article-by mb-4 clearfix">
                                                <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-6 col-md-6">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-2.jpg" data-src="assets/images/blog/blog-2.jpg" alt="image" title="Loremous Comodous - Trending" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">Loremous Comodous - Trending</a></h3>
                                            <div class="article-by mb-4 clearfix">
                                                <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-6 col-md-6">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-2.jpg" data-src="assets/images/blog/blog-2.jpg" alt="image" title="The standard Lorem Ipsum" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">The standard Lorem Ipsum</a></h3>
                                            <div class="article-by mb-4 clearfix">
                                                <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-6 col-md-6">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-2.jpg" data-src="assets/images/blog/blog-2.jpg" alt="image" title="Finibus Bonorum et Malorum" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">Finibus Bonorum et Malorum</a></h3>
                                            <div class="article-by mb-4 clearfix">
                                                <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
                                    ...
                                    <div class="col-sp blog-item col-12 col-sm-6 col-md-6">
                                        <!-- Start Blog Image -->
                                        <div class="blog-img mb-4">
                                            <a href="single-post-image.php" class="animate-scale"><img class="img-fluid blur-up lazyload" src="assets/images/blog/blog-2.jpg" data-src="assets/images/blog/blog-2.jpg" alt="image" title="1914 translation by H. Rackham" /></a>
                                        </div>
                                        <!-- End Blog Image -->
                                        <!-- Start Blog Details -->
                                        <div class="blog-details">
                                            <h3><a href="single-post-image.php">1914 translation by H. Rackham</a></h3>
                                            <div class="article-by mb-4 clearfix">
                                                <span class="article-author float-left"><i class="fa fa-user mr-1"></i> by Demo</span>
