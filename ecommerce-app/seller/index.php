                    ...
                    <div class="container">
                        <div class="row row-sp">
                            <div class="col-sp col-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <form action="../backend/seller/auth/register.php" class="register-form needs-validation" enctype="multipart/form-data" method="post" >
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" class="form-control" placeholder="" required  name="company"  />
                                            <div class="invalid-feedback">Please enter your bussiness name.</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Bussiness Account number *</label>
                                            <input type="number" class="form-control" placeholder="" required  name="bussiness-account-number" />
                                    ...
                                    <div class="form-group col-md-4">
                                            ...
                                            <div class="invalid-feedback">Please enter your Profile Picture / Bussiness logo</div>
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label>Password *</label>
                                            <input type="password" class="form-control" placeholder="" required  name="password"  required/>
                                    ...
                                    <div class="form-group button-action mt-1 mt-sm-5 clearfix text-center">
                                        <button type="submit" class="account-create btn btn-primary" name="submit">Create Seller Account</button>
